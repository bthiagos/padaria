...
<body class="">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h1 class="py-5 text-center text-light px-4" id="sys_title">Sistema de Gestão de Padaria</h1>
        <div class="card my-3 col-md-4 offset-md-4">
            <div class="card-body">
                <form action="" id="login-form">
                    <center><small>Por favor, insira suas credenciais.</small></center>
                    ...
                    <div class="form-group d-flex w-100 justify-content-end">
                        <button class="btn btn-sm btn-primary rounded-0 my-1">Entrar</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    $(function(){
        $('#login-form').submit(function(e){
            ...
            _this.find('button[type="submit"]').text('Fazendo login...')
            $.ajax({
                ...
                error:err=>{
                    ...
                    _this.find('button[type="submit"]').text('Salvo')
                },
