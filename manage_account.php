        ...
        <h3>Gerenciar Conta</h3>
            ...
            <div class="col-md-6">
                <form action="" id="user-form">
                    ...
                    <div class="form-group">
                        <small><i>Deixe o campo Nova senha em branco se não quiser atualizar sua senha.</i></small>
                    </div>
                    <div class="form-group">
                        <label for="old_password" class="control-label">Senha Antiga</label>
                        <input type="password" name="old_password" id="old_password" class="form-control form-control-sm rounded-0" value="">
                    </div>
                    <div class="form-group d-flex w-100 justify-content-end">
                        <button class="btn btn-sm btn-primary rounded-0 my-1">Atualizar</button>
                    </div>
                </form>
            </div>
        </div>
