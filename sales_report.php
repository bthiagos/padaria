    ...
    <div class="card-body">
        ...
        <div class="row align-items-end">
            <div class="form-group col-md-2">
                <label for="date_from" class="control-label">Data de</label>
                <input type="date" name="date_from" id="date_from" value="<?php echo $dfrom ?>" class="form-control rounded-0">
            </div>
            <div class="form-group col-md-2">
                <label for="date_to" class="control-label">Data para</label>
                <input type="date" name="date_to" id="date_to" value="<?php echo $dto ?>" class="form-control rounded-0">
            </div>
            <div class="form-group col-md-4 d-flex">
                <div class="col-auto">
                    <button class="btn btn-primary rounded-0" id="filter" type="button"><i class="fa fa-filter"></i> Filtro</button>
                    <button class="btn btn-success rounded-0" id="print" type="button"><i class="fa fa-print"></i> Imprimir</button>
                </div>
            </div>
        </div>
        <hr>
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Data</th>
                    <th class="text-center p-0">Nº do recibo</th>
                    <th class="text-center p-0">Itens</th>
                    <th class="text-center p-0">Valor Total</th>
                    <th class="text-center p-0">Processado por</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                <?php if($qry->num_rows <=0): ?>
                    <th colspan="6"><center>Nenhuma transação listada na data selecionada.</center></th>
                <?php endif; ?>
...
<script>
    $(function(){
        ...
        $('#print').click(function(){
            ...
            el.append("<div class='text-center lh-1 fw-bold'>Relatório de vendas da farmácia <br/>A partir de<br/>"+date_range+"</div><hr/>")
