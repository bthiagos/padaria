<div class="content py-3">
    <div class="card rounded-0 shadow">
        <div class="card-body">
            <h3>Bem-vindo ao Sistema de Padaria</h3>
            <hr>
            <div class="col-12">
                            ...
                            <div class="card-body">
                                <div class="w-100 d-flex align-items-center">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        <div class="fs-5"><b>Categorias</b></div>
                        ...
                        <div class="card text-dark">
                            <div class="card-body">
                                <div class="w-100 d-flex align-items-center">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        <div class="fs-5"><b>Produtos</b></div>
                                        <div class="fs-6 text-end fw-bold">
                                            <?php
                        ...
                        <div class="card text-dark">
                            <div class="card-body">
                                <div class="w-100 d-flex align-items-center">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        <div class="fs-5"><b>Total Estoque</b></div>
                                        <div class="fs-6 text-end fw-bold">
                                            <?php
                                            $stock = 0;
                        ...
                        <div class="card text-dark">
                            <div class="card-body">
                                <div class="w-100 d-flex align-items-center">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        <div class="fs-5"><b>Vendas do Dia</b></div>
                                        <div class="fs-6 text-end fw-bold">
                                            <?php
