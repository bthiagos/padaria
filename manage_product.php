                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" id="category_id" class="form-select form-select-sm rounded-0 select2" required>
                            <option <?php echo (!isset($category_id)) ? 'selected' : '' ?> disabled>Por favor, selecione aqui</option>
                            <?php
                    ...
                    <div class="form-group">
                        <label for="alert_restock" class="control-label">Alerta de quantidade para reabastecimento</label>
            ...
            $.ajax({
                ...
                error:err=>{
                    ...
                    _el.show('slow')
                     ...
                     $('#uni_modal button[type="submit"]').text('Salvo')
                },
