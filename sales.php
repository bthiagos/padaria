        ...
        <div class="w-100 h-100 d-flex flex-column">
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-end">
                    <button class="btn btn-sm btn-primary rounded-0 " id="transaction-save-btn" type="button">Salvar Transação</button>
                </div>
            ...
            <form action="" class="h-100" id="transaction-form">
                <div class="w-100 h-100 mx-0 row row-cols-2 bg-dark">
                    <div class="col-8 h-100 pb-2 d-flex flex-column">
                        <div>
                            <h3 class="text-light">Selecione o produto abaixo</h3>
                        </div>
                        <div class="flex-grow-1 d-flex flex-column bg-light bg-opacity-50">
                            <div class="form-group py-2 d-flex border-bottom">
                                <label for="search" class="col-auto px-2 fw-bolder text-light">Procurar</label>
                                ...
                                <table class="table table-hover table-striped bg-light mb-0">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="py-0 px-1">Código do Produto</th>
                                            <th class="py-0 px-1">Nome do Produto</th>
                                            <th class="py-0 px-1">Preço</th>
                                            <th class="py-0 px-1">Quantidade Disponível</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                        ...
                        <div class="h-100 d-flex flex-column">
                            <div class="w-100 flex-grow-1">
                                <div class="h-100 d-flex w-100 flex-column">
                                    <div class="d-flex">
                                    <div class="fs-5 fw-bolder text-light flex-grow-1">Itens</div>
                                    <div class="col-auto">
                                    ...
                                    <div>
                                        <table class="table table-hover table-bordered table-striped bg-light m-0">
                                            ...
                                            <thead>
                                                <th class="py-0 px-1 text-center">Qtd</th>
                                                <th class="py-0 px-1 text-center">Produto</th>
